...
/**
  * @brief 设置LCD显示方向
  * @param dir
  *     @arg DIR_XY_RLUD: 从左到右，从上到下
  *     @arg DIR_YX_RLUD: 从上到下，从左到右
  *     @arg DIR_XY_LRUD: 从左到右，从下到上
  *     @arg DIR_YX_LRUD: 从下到上，从左到右
  *     @arg DIR_XY_RLDU: 从右到左，从上到下
  *     @arg DIR_YX_RLDU: 从上到下，从右到左
  *     @arg DIR_XY_LRDU: 从右到左，从下到上
  *     @arg DIR_YX_LRDU: 从下到上，从右到左
  * @retval None
  */
